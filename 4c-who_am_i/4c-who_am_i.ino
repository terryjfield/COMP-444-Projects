...
const char* words[arraySize] = {"MAC", "Address", "Interface", "Ethernet", "Wi-Fi", "Network", "Router", "Switch", "ARP", "Hub", "IPv4",
                                "IPv6", "DHCP", "IP", "Subnet", "Gateway", "Firewall", "Bridge", "LAN", "WAN"
                               };
...
void loop() {
  ...
  for (int i = 0; i < arraySize; i++) {          //for each of the 20 words in the sequence
